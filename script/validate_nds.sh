...
run swift test --package-path "$PACKAGE_DIR" --filter 'NDSDataCatalogTests|NDSDecompSourceTreeIndexTests|NDSROMInspectorTests|ToolchainHealthMatrixTests|PokemonHackCLITests/testNDSDataCatalogCommandEmitsReadOnlyJSON|PokemonHackCLITests/testToolchainHealthCommandSurfacesNDSPreviewRows|PokemonHackCLITests/testMigrationCoverageCommandEmitsSourceFirstAndBlockedJSON|PokemonHackCLITests/testNDSDataSemanticCommandsPlanAndApplyPlatinumEncounterJSONFields|PokemonHackCLITests/testNDSDataSemanticCommandsPlanAndApplyHeartGoldSoulSilverEncounterJSONFields|PokemonHackCLITests/testNDSDataSemanticCommandsPlanAndApplyDiamondPearlEncounterJSONFields|PokemonHackCLITests/testNDSDataSemanticCommandsPlanAndApplyDiamondPearlItemJSONFields'
