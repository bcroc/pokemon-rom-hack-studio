...
| PHS-T98 | Candidate | Gen IV Semantic Data Coverage Expansion | Expand semantic NDS editing one clean-room source-backed domain at a time beyond Platinum JSON species/moves/items/trainers, with evolutions still pending while HGSS/DP, NARC, generated, reference, and ROM rows remain blocked until dedicated planners exist. |
