...
No implementation row is currently active. The live baseline includes `PHS-T68`, `PHS-T69`, `PHS-T70`, `PHS-T71`, `PHS-T72`, `PHS-T74`, `PHS-T80`, `PHS-T81`, `PHS-T82`, `PHS-T86`, `PHS-T87`, `PHS-T88`, `PHS-T89`, `PHS-T90`, `PHS-T91`, `PHS-T91B`, `PHS-T91C`, `PHS-T91D`, `PHS-T94`, `PHS-T95`, `PHS-T96`, `PHS-T98A`, and `PHS-T100`; choose new work from the remaining Active Board candidate rows.
...
| PHS-T97 | Candidate | Gen IV Text Bank Preview V1 | Add read-only message-bank detection and decoded string count/sample facts for safe Gen IV text/BMG-like rows, with blocked write/export diagnostics and no mutation eligibility. |
| PHS-T98 | Candidate | Gen IV Semantic Data Coverage Expansion | Expand semantic NDS editing one clean-room source-backed domain at a time beyond Platinum JSON species/moves, starting with Platinum items/trainers/evolutions while keeping HGSS/DP, NARC, generated, reference, and ROM rows blocked until dedicated planners exist. |
...
| PHS-T99 | Candidate | NDS Extracted Directory Migration Plan | Add a read-only report mapping ROM NitroFS/NARC rows to possible source-tree or extracted-directory targets, reporting unsupported/blocked migration steps without extracting, repacking, rebuilding, exporting, or writing ROMs. |
