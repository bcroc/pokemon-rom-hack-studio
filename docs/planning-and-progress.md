...
No implementation row is currently active. The live baseline includes `PHS-T68`, `PHS-T69`, `PHS-T70`, `PHS-T71`, `PHS-T72`, `PHS-T74`, `PHS-T80`, `PHS-T81`, `PHS-T82`, `PHS-T86`, `PHS-T87`, `PHS-T88`, `PHS-T89`, `PHS-T90`, `PHS-T91`, `PHS-T91B`, `PHS-T91C`, `PHS-T91D`, `PHS-T94`, `PHS-T95`, `PHS-T96`, `PHS-T97`, `PHS-T98A`, `PHS-T98B`, `PHS-T98C`, `PHS-T99`, `PHS-T100`, and `PHS-T101`; choose new work from the remaining Active Board candidate rows.
...
| PHS-T76 | Candidate | Poryscript-Compatible Authoring | Add `.pory` detection, generated `.inc` relationship reporting, poryswitch/line-marker provenance, and compiler/apply planning without copying Poryscript semantics or bypassing existing script source gates. |
...
| PHS-T92 | Candidate | ROM Asset Extraction And Migration Plans | Add read-only ROM asset extraction planning for user-supplied Gen III ROMs, reporting asset-family/revision confidence, tile/palette/tilemap preview metadata, and blocked/source-migration targets without copying reference offset tables or writing assets unless a later ignored-export row opens that scope. |
| PHS-T93 | Candidate | Migration Coverage Diagnostics | Add a source-first migration coverage report mapping legacy binary-editor domains such as species, moves, items, trainers, sprites, icons, footprints, cries, forms, expansion data, and binary-only blocks to supported/source-first/binary-only/blocked PokemonHackStudio surfaces. |
...
| PHS-T98 | Candidate | Gen IV Semantic Data Coverage Expansion | Expand semantic NDS editing one clean-room source-backed domain at a time beyond Platinum JSON species/moves/items/trainers/evolutions, with deeper nested row add/remove/reorder, HGSS/DP, NARC, generated, reference, and ROM rows remaining blocked until dedicated planners exist. |
