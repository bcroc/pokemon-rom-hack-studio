...
No implementation row is currently active. The live baseline includes `PHS-T68`, `PHS-T69`, `PHS-T70`, `PHS-T71`, `PHS-T72`, `PHS-T74`, `PHS-T75`, `PHS-T76`, `PHS-T77`, `PHS-T80`, `PHS-T81`, `PHS-T82`, `PHS-T83`, `PHS-T84`, `PHS-T85`, `PHS-T86`, `PHS-T87`, `PHS-T88`, `PHS-T89`, `PHS-T90`, `PHS-T91`, `PHS-T91B`, `PHS-T91C`, `PHS-T91D`, `PHS-T92`, `PHS-T93`, `PHS-T94`, `PHS-T95`, `PHS-T96`, `PHS-T97`, `PHS-T98A`, `PHS-T98B`, `PHS-T98C`, `PHS-T99`, `PHS-T100`, and `PHS-T101`; choose new work from the remaining Active Board candidate rows. `PHS-T73` patch/ROM export remains gated until a dedicated row opens ignored output ROM writes and patch apply/export commands.
...
| PHS-T57 | Candidate | Compatibility-Specific Data Editors | Umbrella row only; continue through the narrower `PHS-T57C` through `PHS-T57G` compatibility rows driven by the `PHS-T49` compatibility matrix. |
...
| PHS-T57F | Candidate | Pokemon Asset Compatibility Editors | Extend asset authoring beyond the validated species import path into icons, footprints, and profile-specific sprite assets with provenance and palette diagnostics. |
...
| PHS-T73 | Candidate | Patch Apply And ROM Export | Activate patch apply/export from existing manifests with checksum/header policy, backup/export manifests, ignored output paths, explicit user action, and no source-tree mutation; keep RomPatcher.js as format/UX reference only. |
...
| PHS-T98 | Candidate | Gen IV Semantic Data Coverage Expansion | Expand semantic NDS editing one clean-room source-backed domain at a time, starting from Platinum and only then widening to HGSS/DP; deeper nested row add/remove/reorder, NARC, generated, reference, and ROM rows remain blocked until dedicated planners exist. |
