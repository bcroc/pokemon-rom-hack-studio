...
- Evolution add/remove/reorder, `res/trainers/resources/**`, nested trainer-class directories, nested trainer/item/personal/encounter/event arrays or objects outside the explicitly exposed scalar tuple values, nested field-event directories, nested map-matrix directories, map tables, `res/field/maps/**`, `res/field/area_data/**`, HeartGold/SoulSilver CSV item rows and non-JSON encounter/event rows, HGSS/DP trainer-class equivalents, other Diamond/Pearl C anchors, Diamond/Pearl non-integer item mapping or trainer class gender expressions, binary item/personal/trainer/map/script data, ROM-backed rows, NARC/container rows, generated/reference rows, PMD-Sky, extraction, rebuilds, playtest, binary writes, and ROM exports remain blocked/read-only.
